  ...
  const handleKeyDown = (e) => {
    if (e.key === "Enter" && searchValue.trim().length > 0) {
      if (selectedOption === "member") {
        ...
        navigate(
          `/member-search?q=${encodeURIComponent(searchValue)}&type=member`
        );
      } else {
    ...
    <header
      ...
      <div className="container mx-auto px-4 flex items-center justify-between h-16 md:h-20">
        ...
        <div className="hidden lg:flex items-center flex-grow mx-8">
          <div
            ref={ref}
            className="relative flex items-center bg-gray-100 w-full h-12 rounded-lg">
            <div
            ...
            <div className="flex flex-col relative w-full">
              <div className="flex items-center w-full h-12 relative">
                <Search
                  className="text-gray-400 ml-3 mr-2 rtl:ml-2 rtl:rotate-90"
                  size={18}
                />
          ...
          <>
            {token ? (
              <div
                ...
                <LuHeart
                  className="w-5 h-5 text-gray-600 cursor-pointer"
                  onClick={() => navigate("/favorites-item")}
                />
                  ...
                  {profileOpen && (
                    <div className="absolute right-0 mt-2 w-56 bg-white border rounded-lg shadow-lg z-50">
                      <ul className="text-gray-500">
                        <li
                          className="px-4 py-2 hover:bg-gray-100 first:rounded-t-lg last:rounded-b-lg flex items-center gap-2 cursor-pointer"
                          onClick={() => {
                        ...
                        <li
                          ...
                          onClick={() => {
                            navigate("/settings/profile_details");
                            setProfileOpen(false);
                          }}>
